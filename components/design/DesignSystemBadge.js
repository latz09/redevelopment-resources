...
const DesignSystemBadge = () => {
    ...
    return (
        <Link
            href='/design'
            className='fixed bottom-1  right-1 z-50 flex items-center gap-0.75 bg-light border border-accent hover:border-secondary px-1.25 py-0.75 rounded-full transition-all duration-200 group'
        >
