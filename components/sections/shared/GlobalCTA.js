	...
	return (
		<div className='grid lg:grid-cols-2'>
			<ImageWindow
				...
				className='h-[20rem] lg:h-auto order-2 lg:order-1 mx-1 sm:mx-1.25 md:mx-2.5 lg:mx-0 mb-5 lg:mb-0 '
			/>
			<div className='order-1 lg:order-2 py-5 lg:py-8.75 px-1 sm:px-1.25 lg:px-0 lg:pl-6.25 lg:pr-4 space-y-2.5 border-t border-dark/50'>
